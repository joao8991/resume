const LeftSide = (props) => {
    ...
    return (<div className="col-8">
        ...
        <h3 className="fw-bold mb-1" style={{color: appColor}}>Game Developer</h3>
        ...
        <h3 className="fw-bold mb-1" style={{color: appColor}}>Full stack developer</h3>
        <div className="d-flex">
        ...
        <ul>
            ...
            {line("Backend technical challenge of data transfer between many teams and data lakes")}
            ...
            {line("Tech used: React, Java(with Spring), Node.js, Docker, AWS(data transfer, lambdas and deployment), Kafka, Cypress")}
        </ul>
